...
|--------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------|
|    Clock Control           |    Clock Source   - HFINTOSC<br>   HF Internal Clock – 16 MHz<br>   Clock Divider - 1                                                                                                                                                                                                                                                                                  |    System clock                                                            |
|    Configuration   Bits    |    External   Oscillator not enabled <br>   Reset   Oscillator - HFINTOSC (16MHz)                                                                                                                                                                                                                                                                                  |                                                                            |
|    ADCC                    |    Enable ADCC<br>   Input   Configuration- Single Ended Mode<br>   Operating   Mode – Basic Mode<br>   Result   Alignment – Right justified<br>   Positive   Reference – VDD<br>   Auto-conversion   Trigger – TMR2<br>   Acquisition   Count – 50<br>      <br>Clock Source   – FOSC<br>   Clock Divider   – FOSC/16            |    Monitors dust   sensor output                                           |
...
|    PWM1 16-bit             |    Enable PWM<br>   Clock Source   – MFINTOSC 500khz<br>   Disable   Synchronisation<br>     <br>Mode – Left   aligned mode<br>   Requested   Frequency – 0.1 kHz<br>   Output1 Duty   Cycle – 3.2%<br>   Enable   Output1 Polarity<br>   <br>                                                                                            |    Drivers dust   sensor LED                                               |
